...
function main(target, opt)
    ...
    elseif is_plat("wasm") then
        ...
        target:add("rpathdirs", qt.libdir)
        target:add("linkdirs", qt.libdir)
        target:add("ldflags", "-s WASM=1", "-s FETCH=1", "-s FULL_ES2=1", "-s FULL_ES3=1", "-s USE_WEBGL2=1", "-s EXIT_RUNTIME=1", "--bind")
        ...
        target:add("shflags", "-s WASM=1", "-s FETCH=1", "-s FULL_ES2=1", "-s FULL_ES3=1", "-s USE_WEBGL2=1", "-s EXIT_RUNTIME=1", "--bind")
