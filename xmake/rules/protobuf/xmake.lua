...
rule("protobuf.cpp")
    ...
    before_buildcmd_file(function (target, batchcmds, sourcefile_proto, opt)
        import("proto").build_proto_cmd(target, batchcmds, sourcefile_proto, opt, "cxx")
    end)
    on_buildcmd_file(function (target, batchcmds, sourcefile_proto, opt)
        import("proto").build_c_cmd(target, batchcmds, sourcefile_proto, opt, "cxx")
    end)
    before_build_files(function (target, batchjobs, sourcebatch, opt)
        import("proto").build_sourcefiles_proto(target, batchjobs, sourcebatch, opt, "cxx")
    end, {batch = true})
...
rule("protobuf.c")
    ...
    before_buildcmd_file(function (target, batchcmds, sourcefile_proto, opt)
        import("proto").build_proto_cmd(target, batchcmds, sourcefile_proto, opt, "cc")
    end)
    on_buildcmd_file(function (target, batchcmds, sourcefile_proto, opt)
        import("proto").build_c_cmd(target, batchcmds, sourcefile_proto, opt, "cc")
    end)
    before_build_files(function (target, batchjobs, sourcebatch, opt)
