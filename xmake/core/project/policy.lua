...
function policy.policies()
    ...
    if not policies then
        policies = {
            ...
            -- Link target libraries with fullpath when inheriting target links
            ["build.link_target_with_fullpath"]                    = {description = "Link target with fullpath when inheriting target links.", type = "boolean", default = true},
