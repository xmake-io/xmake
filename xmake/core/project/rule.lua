...
function rule.apis()
    ...
    ,   script =
        ...
        ,   "rule.on_scan_files"
        ,   "rule.on_scancmd"
        ,   "rule.on_scancmd_file"
        ,   "rule.on_scancmd_files"
        ,   "rule.on_build"
        ,   "rule.on_build_file"
        ,   "rule.on_build_files"
        ,   "rule.on_buildcmd"
        ...
        ,   "rule.before_config"
        ,   "rule.before_scan"
        ,   "rule.before_scan_file"
        ,   "rule.before_scan_files"
        ,   "rule.before_scancmd"
        ,   "rule.before_scancmd_file"
        ,   "rule.before_scancmd_files"
        ,   "rule.before_build"
        ...
        ,   "rule.after_config"
        ,   "rule.after_scan"
        ,   "rule.after_scan_file"
        ,   "rule.after_scan_files"
        ,   "rule.after_scancmd"
        ,   "rule.after_scancmd_file"
        ,   "rule.after_scancmd_files"
        ,   "rule.after_build"
